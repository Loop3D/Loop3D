...
//    float val = (miscToggle1 + miscToggle2 + miscToggle3 + miscToggle4 + miscToggle5) / 5.0;
    float val = (miscToggle1 + miscToggle2 + miscToggle3 + miscToggle4) / 4.0;
    fragColor = vec4(miscToggle1,miscToggle2,miscToggle3,1.0);
}
