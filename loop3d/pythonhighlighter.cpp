 ...
 : QSyntaxHighlighter(parent)
{
    ...
    basicStyles.insert("brace", getTextCharFormat("yellow"));
...
const QTextCharFormat PythonHighlighter::getTextCharFormat(const QString &colorName, const QString &style)
{
