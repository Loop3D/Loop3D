...
void L3DViewer::setCameraOffsetCP(QVector3D val)
{
    ...
    QMatrix4x4 m;
    m.rotate(m_cameraOffsetCP.y()-90.0f,1.0,0.0,0.0);
...
void L3DViewer::rotate(float horizontalFactor, float verticalFactor)
{
    ...
    float newVerRot = m_cameraOffsetCP.y() + verticalFactor;
...
L3DViewer::L3DViewer()
{
    ...
    m_miscToggle4 = false;
    m_miscToggle5 = false;
    m_cameraPosition = QVector3D(0.0,0.0,50000.0);
    setCameraOffsetCP(QVector3D(0.0,-5.0,50000.0));
    m_lookatPosition = QVector3D(0.0,0.0,0.0);
